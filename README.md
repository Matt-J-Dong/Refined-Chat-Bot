...
## Methodology
In our research, it was clear to see that the evaluation of chat bots were fairly subjective and sometimes tested capabilities that would be outside the scope of our model. In addition to all of these quantitative metrics, we are also looking to sample random Harry Potter fans in order to assess our model on a more subjective basis.
